...
#gost-table(num: "2.1", caption: "Сравнение BunnyMQ и Apache Kafka")[
  #table(
    ...
    [Консенсус / репликация], [Raft (dragonboat v4), multi-raft], [ISR + KRaft (с 3.x)],
    ...
    [acks=1], [Не реализован], [Поддерживается],
    ...
    [Группы потребителей], [Range assignment, v1], [Range, RoundRobin, Sticky, Cooperative],
    ...
    [Хранение смещений групп], [Metadata FSM (Raft)], [Внутренний топик `__consumer_offsets`],
