...
BunnyMQ -- распределенный брокер сообщений с топиками, партициями и группами консьюмеров на базе Raft-репликации. Система рассчитана на эксплуатацию в виде кластера из нескольких узлов (минимум 3) в локальной сети или облачной инфраструктуре.
...
Процесс завершается поэтапно: сначала перестает принимать новые RPC, дожидается завершения текущих, синхронизирует Storage на диск, после чего закрывает dragonboat NodeHost. Типичное время при нагруженном узле -- до 10~секунд.
