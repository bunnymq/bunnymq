...
Зависимости BunnyMQ ограничиваются одним исполняемым файлом на узел и дисковым хранилищем -- ZooKeeper (в отличие от Apache Kafka версий до~3.x), внешняя база данных и объектное хранилище не нужны.
