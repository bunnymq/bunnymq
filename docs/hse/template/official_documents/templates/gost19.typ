...
// ─── Таблица учёта и хранения (ГОСТ 19.601-78) ──────────────
...
#let change-log-page(cipher: "") = {
  ...
  page(
    ...
    #table(
      ...
      rotate(-90deg, reflow: true)[Изменённых],
      rotate(-90deg, reflow: true)[Заменённых],
...
/// Универсальная функция-обёртка для любого ГОСТ 19 документа.
///
/// Параметры:
